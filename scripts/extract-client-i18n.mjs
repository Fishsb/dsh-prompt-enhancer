...
const enStart = src.indexOf('const EN = {', start);
if (start === -1 || enStart === -1) throw new Error('i18n markers not found');
const stageDone = src.indexOf("stageDone: '✓',", enStart);
if (stageDone === -1) throw new Error('i18n end not found');
