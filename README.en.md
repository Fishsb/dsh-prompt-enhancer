...
- 🧪 **Environment check** — an inline button probes the update-restart environment read-only (service / start type / executable / port / update port independence…), each with ✓/⚠/✗ and guidance; one-click update is blocked when not ready
